...
export const responseLinkProductActionUiContract = {
  ...
  currentRouteRequirements: [
    ...
    "server_action_stub_import_reviewed_disabled_only",
    "do_not_import_product_action_boundary",
    "do_not_render_copy_or_reveal_control",
  ],
  currentInertShell: {
    eligibleSurface: "/admin/assignments/[assignmentId]",
    status: "visible_with_disabled_action_binding",
    allowedVisibleCopy: [
    ...
    allowedDisabledMechanics: [
      "route_derived_disabled_action_binding_reference",
      "non_submittable_disabled_panel_copy_only",
    ],
    prohibitedMechanics: [
      "form",
