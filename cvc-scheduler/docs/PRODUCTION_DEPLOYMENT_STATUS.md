...
- First independent encrypted backup, checksum/status, and retention behavior are proven; full restore/post-restore evidence remains blocked at the documented local Supabase managed-role boundary.
