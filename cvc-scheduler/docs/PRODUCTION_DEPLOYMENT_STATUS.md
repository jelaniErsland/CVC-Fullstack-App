...
- First independent encrypted backup, checksum/status, retention, and managed-role compatibility are proven; full restore/post-restore evidence remains blocked by the documented 26 restored `TRUNCATE` grants and unreached type/product/application checks.
