...
- Current approved staging migration level for this gate: `20260812123430`. Historical 12.23/12.23.1 integrated evidence originally passed at `20260714122230`.
...
- Preserve the enabled permanent daily task, the successful 12.35.11 encrypted artifact/checksum/retention evidence, the 12.35.12 no-catch-up proof, safe failure notification, and named recovery/rollback ownership.
