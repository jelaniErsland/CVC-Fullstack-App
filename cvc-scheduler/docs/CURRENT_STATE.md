...
11.12 now provides one direct assignment-response shell on the validated 11.11 bearer boundary. Before any link delivery, review transport, abuse/rate-limit, and operational revocation requirements separately. Keep the mock volunteer portal, Calendar, Volunteers, Communications, and Needs Attention route cutovers—plus email/reminder delivery, broad lookup, and remembered devices—in later reviewed slices.
