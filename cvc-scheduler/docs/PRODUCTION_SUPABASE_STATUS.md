...
| Backup verification | Technical recovery, recurring task registration, safe human-visible failure notification, and recovery/rollback ownership are proven. Production Supabase is on Free and has no managed backups; 12.34 produced the first read-only independent age-encrypted backup at `2026-08-12T17:26:46.3144615Z`, with a matching SHA-256, `62409` encrypted bytes, and daily/weekly retention recognition. 12.35 registered the daily `03:15`/`StartWhenAvailable` task, but its single scheduled production execution stopped at `migration_preflight_failed` without a new artifact. Successful scheduled checksum/retention execution remains blocking. Supabase Pro remains optional |
