...
async function verifyStaticMigrationRiskMap() {
  ...
  assert(migrationContract.includes("20260824123500") && migrationContract.includes("20260902120000") && migrationContract.includes("20260903120000") && migrationContract.includes("20260904120000") && migrationContract.includes("20260904130000"), "The later reviewed backup transition endpoints must remain explicit.");
