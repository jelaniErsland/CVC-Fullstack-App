...
assert.equal(output("select max(version) from supabase_migrations.schema_migrations"), "20260905130000");
...
console.log("PASS systemic ACL: 54 exact functions; 8 public, 34 authenticated, 12 internal; PUBLIC 0; defaults denied; future postgres function denied; 13 direct anon mutations denied before execution; target changes 0; triggers preserved; residue 0.");
